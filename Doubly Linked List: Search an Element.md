...
## Sample Output
![dll-search](https://github.com/user-attachments/assets/becfcf06-e7f3-4468-8e43-27d0d6b47454)


## Result
Thus a Python program that:
- Implements a **Doubly Linked List** with functions to insert elements at the beginning and the end of the list.
- Implements a search function to check if a given element exists in the list. is created.
