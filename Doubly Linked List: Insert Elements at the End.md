...
```
## Sample Output
![dll-insert at end](https://github.com/user-attachments/assets/b92bdcc2-2fb3-4774-a2b2-70d18ce0e9c2)
...
Implements a **Doubly Linked List**.
 Allows insertion of elements at the end of the list.
 Provides functionality to traverse the list and display its elements is created.
